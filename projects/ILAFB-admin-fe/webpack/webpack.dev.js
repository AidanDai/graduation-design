...
let config = {
    ...
    new AddAssetHtmlPlugin(
		...
		new AddAssetHtmlPlugin(
			{ 
				filepath: path.resolve(__dirname, 
				'../assets/javascripts/vendors/graffiti/assets/icons/style.css'),
		...
		new AddAssetHtmlPlugin(
			{ 
				filepath: path.resolve(__dirname, 
				'../assets/javascripts/vendors/graffiti/assets/style.css'),
				includeSourcemap: false,
				typeOfAsset: 'css'
			}
		),
		new AddAssetHtmlPlugin(
			{ 
				filepath: path.resolve(__dirname, 
				'../assets/javascripts/vendors/graffiti/default.js'),
				includeSourcemap: false
			}
		),
		new AddAssetHtmlPlugin(
			{ 
				filepath: path.resolve(__dirname, 
				'../assets/javascripts/vendors/graffiti/fileapi-canvas.js'),
				includeSourcemap: false
			}
		),
		new AddAssetHtmlPlugin(
			{ 
				filepath: path.resolve(__dirname, 
				'../assets/javascripts/vendors/graffiti/assets/exif.js'),
				includeSourcemap: false 
			}
		),
		new AddAssetHtmlPlugin(
			{ 
				filepath: path.resolve(__dirname, 
				'../assets/javascripts/vendors/graffiti/assets/binaryajax.js'),
				includeSourcemap: false
			}
		),
		new AddAssetHtmlPlugin(
			{ 
				filepath: path.resolve(__dirname, 
				'../assets/javascripts/vendors/graffiti/assets/toBlob.js'),
				includeSourcemap: false
			}
		),
